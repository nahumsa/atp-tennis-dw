...
SELECT
    CASE WHEN w.sk_player_key < l.sk_player_key THEN w.desc_name ELSE l.desc_name END AS player1,
    CASE WHEN w.sk_player_key < l.sk_player_key THEN l.desc_name ELSE w.desc_name END AS player2,
    COUNT(*) AS matches,
    ...
    SUM(CASE WHEN mf.fk_winner_id = CASE WHEN w.sk_player_key < l.sk_player_key THEN l.sk_player_key ELSE w.sk_player_key END THEN mf.nst_winner_stats.ace ELSE mf.nst_loser_stats.ace END) AS p1_total_aces,
  SUM(CASE WHEN mf.fk_winner_id = CASE WHEN w.sk_player_key < l.sk_player_key THEN w.sk_player_key ELSE l.sk_player_key END THEN mf.nst_winner_stats.ace ELSE mf.nst_loser_stats.ace END) AS p1_total_aces,
...
GROUP BY
    CASE WHEN w.sk_player_key < l.sk_player_key THEN w.desc_name ELSE l.desc_name END,
    CASE WHEN w.sk_player_key < l.sk_player_key THEN l.desc_name ELSE w.desc_name END
